...
public class update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("Update - Citizen Information System"), this, org.jdesktop.beansbinding.BeanProperty.create("title"));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextField21, javax.swing.GroupLayout.DEFAULT_SIZE, 259, Short.MAX_VALUE)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Permanant Address"));

        jLabel7.setText("Flat/Door/Block No.");

        jLabel8.setText("Name of Premises/Building/Village");
        ...
        jLabel16.setText("AADHAR UIDAI (GOI)");
 ...
 new menu ().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null, "Wana update the record for Sure ?");
        if (a==JOptionPane.YES_OPTION) {
            try {
                ...
                String qry = "  UPDATE cis SET  "
                        ...
                        + "pc = '"+jTextField12.getText() +" ',"
                        + "fna = '"+jTextField13.getText() +" ',"
                        + "mna = '"+jTextField14.getText() +" ',"
                        + "na = '"+jTextField15.getText() +" ',"
                        + "re = '"+jTextField16.getText() +" ',"
                        + "nos = '"+jTextField17.getText() +" ',"
                        + "pan = '"+jTextField18.getText() +" ',"
                        + "vi = '"+jTextField19.getText() +" '"
                        + " WHERE id = "+jTextField20.getText() + ";";
                stmt.executeUpdate(qry);
                JOptionPane.showMessageDialog(null, "Record  Update");
            }catch(Exception e) {
                JOptionPane.showMessageDialog(null,"Error in Updation!/ In coding");
            }
        }
        jTextField1.setText(null);
        jTextField2.setText(null);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            String qry = "select * from cis where id="+jTextField20.getText()+";";
            ...
            JOptionPane.showMessageDialog(null, "your program have error ?");
