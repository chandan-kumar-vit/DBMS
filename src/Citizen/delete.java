...
public class delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("Delete - Citizen Information System  "), this, org.jdesktop.beansbinding.BeanProperty.create("title"));
 ...
 new menu ().setVisible(true);
  ...
  int a = JOptionPane.showConfirmDialog(null, "Wana delete the record for Sure ?");
        if (a==JOptionPane.YES_OPTION) {
            try {
                stmt = con.createStatement();
                String qry ="DELETE FROM cis WHERE ID = " +jTextField20.getText() + ";"  ;
