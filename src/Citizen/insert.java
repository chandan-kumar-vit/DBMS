...
public class insert extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("Insert - Citizen Information System"), this, org.jdesktop.beansbinding.BeanProperty.create("title"));
 ...
 new menu ().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      int a = JOptionPane.showConfirmDialog(null, "Wana Insert  the record for Sure?");
        if (a==JOptionPane.YES_OPTION) {
            try {
                ...
                String qry ="INSERT INTO cis(fn,mn,ls,cn,em,fdb,nv,po,area,city,state,pc,fna,mna,na,re,nos,pan,vi,id) "
                ...
                JOptionPane.showMessageDialog(null, "New Record Insert  ");
