...
public class login extends javax.swing.JFrame {
    ...
    public login() {
         ...
         try
        {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/citizensystem","root","");
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("UIDAI BY Govt. Of India");
        ...
        jPasswordField1.setFont(new java.awt.Font("Webdings", 0, 18)); // NOI18N
